...
def make_heuristic(goals, campus_map,
                   move_cost=1, min_vertical_cost=21.9,
                   diagonal=True):
    """
    ...
    min_vertical_cost : cheapest floor-change cost per floor (default: COST_ELEVATOR_FLOOR = 21.9)
...
def make_euclidean_heuristic(goals, move_cost=1, min_vertical_cost=21.9):
    """
